...
const AIMLItems = [
	{
		link: "https://fadileledath.com/blog/g-speak",
		title: "g-speak",
		doneFor: "Personal",
		timePeriod: [2026],
	...
	},
	{
		...
		doneFor: "Personal",
		timePeriod: [2026],
		extract: "Inspired by the variety of clouds I get to see in Houston, I wanted to better understand them and learn to classify them. I figured that building a PokeDex for the sky would be the perfect way to do it so I made one.",
		skills: ["typescript"],
		image: "/thumbnails/sky-sight.png",
	},
	{
		link: "https://github.com/fadilf/celeb-data",
		title: "celeb-data",
		doneFor: "Personal",
		timePeriod: [2026],
		extract: "I analyzed data from Wikipedia on notable celebrity deaths + their pageview trends over the past decade to find out if people have been moving on from celebrity deaths slower/faster over time. The answer? Surprisingly, there's been no change.",
		skills: ["python"],
		image: "/thumbnails/celeb-data.png",
	},
	{
		link: "https://github.com/fadilf/entourage",
		title: "Entourage",
		doneFor: "Personal",
		timePeriod: [2026],
		extract: "After playing with CLI agents, I wanted to set up a way to run them on a home lab while allowing me to switch between them and handle parallel tasks efficiently. Hence, I made a web app that manages them in Slack-like workspaces.",
		skills: ["typescript"],
		image: "/thumbnails/entourage.png",
	},
	{
